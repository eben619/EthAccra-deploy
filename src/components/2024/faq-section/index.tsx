...
const FaqSection = () => {
  return (
    <motion.div
      className="bg-white lg:px-10 pt-[153px] pb-[114px] lg:pb-0 largeSc border-none"
      initial={{ opacity: 0 }}
    ...
    >
      <div className={styles.faqSectionContainer}>
        <div className="lg:w-4/12">
          <h1 className="sectionText">Frequently Asked Questions</h1>
        </div>

        <div className="lg:w-8/12">
          <AccordionRoot defaultValue="item-1" accordionType="2024">
            ...
            <AccordionRoot.AccordionItem value="item-7">
              ...
              <AccordionRoot.AccordionContent>
                <div>
                  ...
                  August, with the Closing Ceremony and the Afterparty to follow.
                </div>
              </AccordionRoot.AccordionContent>
            </AccordionRoot.AccordionItem>
            ...
            <AccordionRoot.AccordionItem value="item-11">
              ...
              <AccordionRoot.AccordionContent>
                <div>
                  ...
                  &nbsp;
                  <a className="text-[#FFA500] underline" href="https://t.me/+7ClMFsYpii05NGQ0" target="_blank">Telegram</a> ,
                  &nbsp;
                  <a className="text-[#FFA500] underline" href="https://twitter.com/ETHAccra" target="_blank"> X </a>
                  &nbsp;
                  or
                  &nbsp;
                  <a className="text-[#FFA500] underline" href="mailto:info@ethaccra.xyz"> Email </a>.
                </div>
              </AccordionRoot.AccordionContent>
            </AccordionRoot.AccordionItem>
          </AccordionRoot>
